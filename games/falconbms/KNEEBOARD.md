...
- Mini-stick (stick) — 5
- Trigger initial lever (stick) — 1, 0
- Main trigger (stick) — 2, 3, 4
- Thumb top button (stick) — 6
- Top thumb hat (stick) — 8, 11, 10, 9, 7
- Thumb bottom button (stick) — 12
- Bottom thumb hat (stick) — 14, 17, 16, 15, 13
- Grip thumb hat (stick) — 23, 26, 25, 24, 22
- Grip pinky button (stick) — 30
- Analogue brake lever on the grip (stick) — no buttons
- Left side dial (throttle) — 33
- Pinky button (throttle) — 32
- Right side dial (throttle) — 40
- Thumb mini-stick (throttle) — 46
- Middle finger button (throttle) — 34
- Middle finger hat (throttle) — 36, 37, 38, 39, 35
- Thumb button (throttle) — 47
- Bottom thumb button (throttle) — 48
- Thumb hat (throttle) — 50, 51, 52, 53, 49
- Keyboard B1 button (throttle) — 54
- Keyboard B2 button (throttle) — 55
- Keyboard B3 button (throttle) — 56
- Keyboard B4 button (throttle) — 57
- Keyboard B5 button (throttle) — 58
- Keyboard B6 button (throttle) — 59
- Big red button (throttle) — 60
